  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 font-sans flex flex-col">
      ...
      <Helmet>
        ...
        <meta property="og:image" content="https://quotekaro.in/og-image-blog.jpg" /> {/* Replace with a suitable blog page image */}
        ...
        <meta name="twitter:image" content="https://quotekaro.in/twitter-image-blog.jpg" /> {/* Replace with a suitable blog page image */}
